...
description: ""
image: "/img/pics/oppenheimer-misc-notes.webp"
...
<table style="border-collapse: collapse; margin: 20px auto; text-align: center; width: 100%; max-width: 900px;">
  ...
  <thead>
    ...
    <tr>
      ...
      <th style="border: 1px solid black; padding: 8px;">M (23)</th>
      <th style="border: 1px solid black; padding: 8px;">E (11)</th>
      <th style="border: 1px solid black; padding: 8px;">M (52)</th>
    </tr>
  </thead>
  ...
  <tbody>
    <tr>
      ...
      <td style="border: 1px solid black; padding: 8px;">0</td>
      <td style="border: 1px solid black; padding: 8px;">0</td>
      <td style="border: 1px solid black; padding: 8px;">true zero (±0)</td>
    </tr>
    <tr>
      <td style="border: 1px solid black; padding: 8px;">0</td>
    ...
    <tr>
      <td style="border: 1px solid black; padding: 8px;">1–254</td>
      <td style="border: 1px solid black; padding: 8px;">anything</td>
      <td style="border: 1px solid black; padding: 8px;">1–2046</td>
      <td style="border: 1px solid black; padding: 8px;">anything</td>
    ...
    <tr>
      ...
      <td style="border: 1px solid black; padding: 8px;">0</td>
      <td style="border: 1px solid black; padding: 8px;">infinity (±∞)</td>
    </tr>
    <tr>
      <td style="border: 1px solid black; padding: 8px;">255</td>
      <td style="border: 1px solid black; padding: 8px;">nonzero</td>
