...
Solar Tachocline Problem: The role of non-axisymmetric dynamo magnetic fields in solar tachocline confinement
------------------------------------------------------------------------------------------------------------------
...
We know it is a dynamo because of Hale's polarity rules.

solar dynamo problem.

- strong (20%-30%) solar differential rotation 
- increases with depth in outer 5% (NSSL)
- lots of radial shear here which is what you need to create a strong ? field 
- smth related to tachocline 

How is the shear layer generated and how does it remain stable?

Issues with the tachocline:
- how does the tachocline retain its integrity every sun down? 
- another one 

Eddington sweet process?


Fast magnetic confinement scenario: 
<center>$$\frac{\partial u}{\partial t} = \nu \frac{\partial^2 u}{\partial y^2}$$</center>
Stokes second problem. Approxkimately flipped and changed to:
<center>$$\frac{\partial \mathbf{B}_{pol}}{\partial t} = \nu \frac{\partial^2 \mathbf{B}_{pol}}{\partial r^2}$$</center>
both of these had different $\delta$ values or something....

- anelastic MHD equations in a spherical shell?
- this was solved with "The Rayleigh Code" which is really good for solving things on spheres.

top and bottom boundary conditions something about fixed and fixed? and some other condition.

"every grad student with Juri [Toomre] has had to face the tachocline, and I [Loren Matlisky] was no different"

- at low $Pr_m$ weak-field dynamo $ME << KE$ (magnetic and kinetic energy)
- at high $Pr_m$ strong-field dynamo $ME \sim KE$ 
- maybe medium-field regime as well

- skin effect for axisymmetric fields

- heliscity? invariant of the MHD?

- no seminar next two weeks (in two weeks, bay area planetary science progrma)